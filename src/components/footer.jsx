...
function Footer(){
    return <div class="foot1">
    <div class="nfooter">
        <footer>
            <div class="ofooter">
                <h1 class="footext">Categories</h1>
                <p class="footitems"><a href="#">Grocery</a></p>
                <p class="footitems"><a href="#">Daily essentials</a></p>
                <p class="footitems"><a href="#">Pharmaceuticals</a></p>
                <p class="footitems"><a href="#">Personal care</a></p>
                <p class="footitems"><a href="#">Dairy & Breakfast</a></p>
                <p class="footitems"><a href="#">Atta,Rice & Dal</a></p>
                <p class="footitems"><a href="#">Tea,Coffee & Milk drinks</a></p>
            </div>
        </footer>
    </div>
    <div class="foot2">
        <p class="footitems">Made by Vedant chavare 🛍️</p>
        <p class="footitems">Connect me on-</p>
        <ul class="example-1">
